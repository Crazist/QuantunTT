...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct AnimSettings : Quantum.IComponent {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 18719;
        hash = hash * 31 + JumpDelayLeft.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (AnimSettings*)ptr;
        FP.Serialize(&p->JumpDelayLeft, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct LevelPortal : Quantum.IComponent {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 10343;
        hash = hash * 31 + TargetLevel.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (LevelPortal*)ptr;
        AssetRef.Serialize(&p->TargetLevel, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct PlayerLink : Quantum.IComponent {
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        PlayerRef.Serialize(&p->PlayerId, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Pushable : Quantum.IComponent {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 15373;
        hash = hash * 31 + Resistance.GetHashCode();
        hash = hash * 31 + MaxPushSpeed.GetHashCode();
        hash = hash * 31 + BaseMass.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (Pushable*)ptr;
        FP.Serialize(&p->BaseMass, serializer);
        FP.Serialize(&p->MaxPushSpeed, serializer);
        FP.Serialize(&p->Resistance, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Pushing : Quantum.IComponent {
    public const Int32 SIZE = 32;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    public EntityRef Box;
    [FieldOffset(16)]
    public FP BoxSpeed;
    [FieldOffset(24)]
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + BoxSpeed.GetHashCode();
        hash = hash * 31 + OriginalSpeed.GetHashCode();
        hash = hash * 31 + IsPushing.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (Pushing*)ptr;
        QBoolean.Serialize(&p->IsPushing, serializer);
        EntityRef.Serialize(&p->Box, serializer);
        FP.Serialize(&p->BoxSpeed, serializer);
        FP.Serialize(&p->OriginalSpeed, serializer);
    }
  }
  ...
  public unsafe partial class Frame {
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.AnimSettings>();
      BuildSignalsArrayOnComponentRemoved<Quantum.AnimSettings>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.LevelPortal>();
      BuildSignalsArrayOnComponentRemoved<Quantum.LevelPortal>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.Pushable>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Pushable>();
      BuildSignalsArrayOnComponentAdded<Quantum.Pushing>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Pushing>();
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      typeRegistry.Register(typeof(Quantum.AnimSettings), Quantum.AnimSettings.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.LevelPortal), Quantum.LevelPortal.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.Pushable), Quantum.Pushable.SIZE);
      typeRegistry.Register(typeof(Quantum.Pushing), Quantum.Pushing.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 6)
        ...
        .Add<Quantum.AnimSettings>(Quantum.AnimSettings.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.CharacterStats>(Quantum.CharacterStats.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.LevelPortal>(Quantum.LevelPortal.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PlayerLink>(Quantum.PlayerLink.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.Pushable>(Quantum.Pushable.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.Pushing>(Quantum.Pushing.Serialize, null, null, ComponentFlags.None)
        .Finish();
    }
    [Preserve()]
